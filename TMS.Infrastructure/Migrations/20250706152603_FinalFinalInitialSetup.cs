...
{
    /// <inheritdoc />
    public partial class FinalFinalInitialSetup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TicketCounterId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LocationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CounterName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    CounterCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SeatId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BookingCounterId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DepartureCounterId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ArrivalCounterId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PassengerName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PassengerContact = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FarePaid = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketCounters_LocationId_CounterName",
                table: "TicketCounters",
                columns: new[] { "LocationId", "CounterName" },
                unique: true);
